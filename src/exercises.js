...
export const EXERCISES = [
  ...
  },
  {
    ...
    pattern: 'anti-extension',
    concept: 'Wie das Ab Wheel, aber weicher — große Kontaktfläche ermöglicht progressivere Steigerung.',
    variants: [
      {
        level: 'easy',
        label: 'Leicht',
        name: 'Ball Rollout — kniend kurz',
        desc: 'Unterarme auf dem Ball, kurz vorwärts rollen und zurück.',
        cue: 'Rücken bleibt neutral — kein Hohlkreuz beim Ausrollen.',
      },
      {
        level: 'medium',
        label: 'Mittel',
        name: 'Ball Rollout — kniend weit',
        desc: 'Weiter ausrollen auf dem Ball, mehr Körperlänge.',
        cue: 'Schulterblätter stabil halten — nicht durchhängen lassen.',
      },
      {
        level: 'hard',
        label: 'Schwer',
        name: 'Ball Rollout — stehend Füße',
        desc: 'Füße auf dem Ball, Hände am Boden, Hüfte heben und senken (Pike).',
        cue: 'Hüfte gerade oben — kein Hohlkreuz unten.',
      },
      {
        level: 'maximum',
        label: 'Maximum',
        name: 'Ball Pike + Rollout',
        desc: 'Aus der Pike-Position Knie zur Brust ziehen und wieder strecken.',
        cue: 'Kontrolliert und langsam — Schnelligkeit ist hier kein Ziel.',
      },
    ],
  },
  {
  ...
  {
    id: 'ab-rollout-standing',
    name: 'Stehender Ab Rollout',
    pattern: 'anti-extension',
    concept: 'Maximale Anti-Extension vom Stand — eine der schwersten Rumpfübungen überhaupt.',
    variants: [
      {
        level: 'easy',
        label: 'Leicht',
        name: 'Rollout an der Wand',
        desc: 'Stehend vor einer Wand, Hände rollen an der Wand nach oben. Rumpf hält.',
        cue: 'Rücken gerade — sobald er sich wölbt, bist du zu weit.',
      },
      {
        level: 'medium',
        label: 'Mittel',
        name: 'Rollout — Barbell',
        desc: 'Stehend, Barbell oder ab-wheel vom Boden weit ausrollen. Kein Knie-Kontakt.',
        cue: 'Ausatmen beim Ausrollen — so bleibt die intraabdominale Spannung.',
      },
      {
        level: 'hard',
        label: 'Schwer',
        name: 'Rollout — tief',
        desc: 'Fast bis zum Boden ausrollen, Körper fast flach. Nur die Rumpfspannung hält.',
        cue: 'Der Rückweg ist genauso wichtig — aus der Kraft zurück, nicht kippen.',
      },
      {
        level: 'maximum',
        label: 'Maximum',
        name: 'Rollout — volle Strecke',
        desc: 'Vollständiges Ausrollen bis die Brust fast den Boden berührt. Sehr langsam.',
        cue: '5 Sekunden raus, 5 Sekunden zurück — Tempo ist Kontrolle.',
      },
    ],
  },
  {
